...
+ (void)showWithView:(UIView *)view style:(JTProgressHUDStyle)style transition:(JTProgressHUDTransition)transition backgroundAlpha:(CGFloat)backgroundAlpha {
    ...
    // Properties
    sharedInstance.styleColor1 = [[UIColor lightGrayColor] colorWithAlphaComponent:backgroundAlpha - kBGColorAlphaSkip];
...
- (UIView *)createCircleWithWidth:(CGFloat)size {
    ...
    circle.layer.borderColor = [[UIColor colorWithRed: 1.0 green: 0.6 blue: 0.35 alpha: 1] colorWithAlphaComponent:0.9].CGColor;
